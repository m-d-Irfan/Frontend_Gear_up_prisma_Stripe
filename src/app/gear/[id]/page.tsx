...
export default function GearDetailsPage({
  ...
  const handleRentNow = async () => {
    if (!isAuthenticated || !user) {
      ...
      router.push(`/login?callbackUrl=/gear/${gearId}`);
      return;
    }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        {/* Right Column: Interactive Rental Date Calculator Box */}
        <div className="lg:col-span-1">
          <div className="glass-card bg-slate-900/95 p-6 rounded-3xl border border-slate-800 shadow-2xl space-y-6 sticky top-24">
