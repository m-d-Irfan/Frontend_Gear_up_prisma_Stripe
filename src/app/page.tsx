            ...
            <div className="bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950 text-white rounded-3xl p-8 sm:p-14 border border-slate-800 shadow-2xl relative overflow-hidden">
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
                ...
                <div className="lg:col-span-5 space-y-4">
                  <div className="bg-white/5 backdrop-blur-sm p-5 rounded-2xl border border-white/10 flex flex-col space-y-2">
                    <div className="flex items-center space-x-3">
                      <ShieldCheck className="w-5 h-5 text-emerald-400" />
                      <h4 className="font-bold text-white text-sm">100% Escrow Security</h4>
                    </div>
                  ...
                  <div className="bg-white/5 backdrop-blur-sm p-5 rounded-2xl border border-white/10 flex flex-col space-y-2">
                    <div className="flex items-center space-x-3">
                      ...
                      <h4 className="font-bold text-white text-sm">Verified Local Renters</h4>
                    </div>
                    <p className="text-xs text-slate-400 leading-relaxed">
